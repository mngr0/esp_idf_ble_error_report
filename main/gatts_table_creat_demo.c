...
// int i2c_read_register(uint8_t reg_addr, uint8_t *data, size_t len){
//    return i2c_master_write_read_device(I2C_MASTER_NUM, MCP7940_DEFAULT_ADDRESS, &reg_addr, 1, data, len, I2C_MASTER_TIMEOUT_MS / portTICK_RATE_MS);
// }

// int i2c_write_byte(uint8_t reg_addr, uint8_t data){
//     uint8_t write_buf[2] = {reg_addr, data};
//     return i2c_master_write_to_device(I2C_MASTER_NUM, MCP7940_DEFAULT_ADDRESS, write_buf, sizeof(write_buf), I2C_MASTER_TIMEOUT_MS / portTICK_RATE_MS);
// }
...
static void blink_task(void *arg)
{
    ...
    while (1)
    {
        ...
        counter++;
        counter %= 8;
        ESP_LOGI("TEST_CS", "doing: %d %d %d", led_blink[counter][0], led_blink[counter][1], led_blink[counter][2]);
    }
}
