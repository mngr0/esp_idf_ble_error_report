...
static const uint16_t GATT_AR_STATE_UUID_SERVICE = (0xFF00 | GATT_AR_STATE_IDX_SERVICE) & (PROFILE_AR_STATE << 8);
...
const esp_gatts_attr_db_t gatt_ar_state_db[HRS_IDX_NB] =
    {
        ...
        [GATT_AR_STATE_IDX_COMPRESSOR_ACTUAL_SPEED_INDEX_DECL] = {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_declaration_uuid, ESP_GATT_PERM_READ, CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write_notify}},
        // Service Declaration
