...
static const uint16_t GATT_BLUEFI_UUID_SERVICE = (0xFF00 | GATT_BLUEFI_IDX_SERVICE) & (INDEX_BLUEFI <<8);
...
//         esp_err_t create_attr_ret = esp_ble_gatts_create_service(gatts_if, &heart_rate_profile_tab[INDEX_BLUEFI].service_id, GATT_BLUEFI_NB);
//         if (create_attr_ret)
//         {
